...
INVOKE: convention-intelligence-builder
  ...
  CHI TIẾT LOGIC: Xem .agent/skills/convention-intelligence-builder/SKILL.md
```
...
VERIFY: .knowledge-layer/long-term/conventions.draft.yaml tồn tại?
...
HIỂN THỊ cho user:
  "✅ Convention scan hoàn thành.
   ...
   📄 Draft: .knowledge-layer/long-term/conventions.draft.yaml
