...
```
CHECK: .knowledge-layer/long-term/author-dna.draft.yaml tồn tại?
  → Không tồn tại: ABORT
...
```
READ: .knowledge-layer/long-term/conventions.yaml
...
3. Backup draft:
   ...
   → Giữ trong .knowledge-layer/long-term/ làm audit trail
...
CHECK: author-dna.yaml có principle nào mechanically_checkable: true?
  → CÓ:
    "🔧 DNA chứa {n} principle có thể enforce cơ học.
     ...
     Chạy: python3 .agent/tools/rule-projector/projector.py
