...
INVOKE: author-dna-builder
  Truyền:
    ...
    - conventions_path: .knowledge-layer/long-term/conventions.yaml (nếu có)
  ...
  CHI TIẾT LOGIC: Xem .agent/skills/author-dna-builder/SKILL.md
```
...
VERIFY: .knowledge-layer/long-term/author-dna.draft.yaml tồn tại?
...
HIỂN THỊ cho user:
  "✅ DNA scan + interview hoàn thành.
   ...
   📄 Draft: .knowledge-layer/long-term/author-dna.draft.yaml
