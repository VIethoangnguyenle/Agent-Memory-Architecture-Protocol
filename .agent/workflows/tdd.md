...
### Bước 1 — Load Skill
```
READ: .agent/skills/infra-tdd/SKILL.md
```
...
### Bước 3 — Tạo TDD
```
COPY: .agent/skills/infra-tdd/assets/TDD_TEMPLATE.md → docs/tdd/<module>-TDD.md
```
...
```
READ: .agent/skills/infra-tdd/references/socratic-deep-dive.md
```
Chạy deep-dive cho mỗi quyết định non-trivial trong T3.

### Bước 5 — Viết ADR
```
READ: .agent/skills/infra-tdd/references/adr-guide.md
COPY: .agent/skills/infra-tdd/assets/ADR_TEMPLATE.md → docs/tdd/<module>-adr/NNNN-title.md
```
